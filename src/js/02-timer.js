...
const daysCounter = qs('span[data-days]');
const hoursCounter = qs('span[data-hours]');
const minutesCounter = qs('span[data-minutes]');
const secondsCounter = qs('span[data-seconds]');
